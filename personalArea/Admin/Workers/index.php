                                ...
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    ...
                                    <div class="table-primary" style="padding-left: 20px;">
                                        <table>
                                            <tr>
                                                <td>
                                                    <a class='nav-link active' href='index.php'>List workers</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                        ...
                                        echo "<table class='table table-bordered'>";
                                            ...
                                            do{
                                                echo "<tr>";
                                                    ...
                                                    echo "<td style='text-align: center'><a href='delete.php?worker=$listID'><i class='fa fa-trash' style='font-size:20px;color:red'></i></a></td>";
                                                echo "</tr>";
