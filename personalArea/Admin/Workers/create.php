                                ...
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            <a class="nav-item nav-link" href="index.php" role="tab" aria-selected="false">List workers</a>
                                            <a class="nav-item nav-link active" id="mediumPriority" href="create.php" role="tab" aria-selected="true">Create worker</a>
                                        </div>
                                    </nav>
